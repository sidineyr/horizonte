...
## Idioma
As traduções já fazem parte dos arquivos do site. O seletor não utiliza serviços externos, não envia respostas para tradução e não registra o idioma em banco de dados ou armazenamento do navegador. A escolha permanece apenas na memória da página.